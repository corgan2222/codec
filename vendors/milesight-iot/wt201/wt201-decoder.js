...
function milesight(bytes) {
    ...
    for (var i = 0; i < bytes.length; ) {
        ...
        // CONTROL PERMISSIONS
            ...
            decoded.control_permissions = bytes[i];
            i += 1;
        }
        // TEMPERATURE ALARM
        ...
        // TEMPERATURE EXCEPTION
            ...
            decoded.temperature_exception = bytes[i];
            i += 1;
        }
        // HUMIDITY EXCEPTION
        else if (channel_id === 0xb9 && channel_type === 0x68) {
            decoded.humidity_exception = bytes[i];
            i += 1;
        }
        // HISTORICAL DATA
...
function handle_downlink_response_ext(channel_type, bytes, offset) {
    ...
    switch (channel_type) {
        ...
        case 0x06:
            ...
            break;
        case 0x07:
            var fan_dehumidify_control_result = readUInt8(bytes[offset + 2]);
            if (fan_dehumidify_control_result === 0) {
        ...
        case 0x09:
            ...
            break;
        case 0x0a:
            var temperature_dehumidify_result = readUInt8(bytes[offset + 2]);
            if (temperature_dehumidify_result === 0) {
