...
function milesight(bytes) {
    ...
    for (var i = 0; i < bytes.length; ) {
        ...
        // LIQUID
            ...
            var liquid_value = bytes[i];
            if (liquid_value === 0xff) {
                decoded.liquid_alarm = 0xff;
            } else {
                decoded.liquid = liquid_value;
            }
            i += 1;
        }
        // CALIBRATION RESULT
        ...
        // LIQUID ALARM
            ...
            decoded.liquid = bytes[i];
            decoded.liquid_alarm = bytes[i + 1];
            i += 2;
        } else {
            break;
        }
